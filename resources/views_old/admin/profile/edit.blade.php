...
<div class="bg-white rounded-lg shadow-sm border p-6 mb-6">
    ...
    <button type="submit" class="bg-blue-600 text-white px-6 py-3 rounded">Enregistrer les modifications</button>
    </form>
</div>
...
<div class="bg-white rounded-lg shadow-sm border p-6">
    ...
    <button type="submit" class="bg-blue-600 text-white px-6 py-3 rounded">Changer le mot de passe</button>
    </form>
</div>

<a href="{{ route('admin.dashboard') }}" class="mt-6 inline-block bg-gray-200 text-gray-800 px-6 py-3 rounded">Retour au tableau de bord</a>
