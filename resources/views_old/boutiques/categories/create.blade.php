...
@section('title', 'Créer une catégorie - ' . $boutique->name . ' - Sanar Market')
...
<section class="user-dashboard-hero">
    <div class="user-dashboard-container">
        ...
        <p>Ajoutez une nouvelle catégorie pour organiser les articles de votre boutique.</p>
    </div>
</section>
    ...
    <div class="user-dashboard-shell">
        ...
        <div class="user-dashboard-main">
            <div class="form-card">
                ...
                <form method="POST" action="{{ route('boutiques.categories.store', $boutique) }}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        @error('description')
                            <p class="form-error">{{ $message }}</p>
                        @enderror
                        <p class="form-help">Une description aide les clients à mieux comprendre cette catégorie.</p>
                    </div>
