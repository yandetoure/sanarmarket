...
<body class="bg-gradient-to-br from-gray-50 to-blue-50">
    ...
    <nav class="fixed top-0 left-0 right-0 z-50 bg-white shadow-lg border-b border-gray-200">
            ...
            <div class="flex justify-between items-center h-14">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('announcements.create') }}" class="bg-gradient-to-r from-green-500 to-green-600 text-white px-3 py-2 rounded-lg text-sm font-medium flex items-center shadow-md hover:from-green-600 hover:to-green-700 transition-all">
    ...
    <div class="flex pt-14">
        <!-- Left Sidebar - Fixed -->
        <div class="fixed left-0 top-14 w-56 h-[calc(100vh-3.5rem)] bg-gradient-to-b from-white to-gray-50 shadow-xl border-r border-gray-200 z-40 flex flex-col">
