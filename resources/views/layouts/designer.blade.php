            ...
            <div class="p-6">
                <nav class="space-y-2">
                    ...
                    <div class="pt-6">
                        ...
                        <div class="px-4 mb-2">
                            <a href="{{ route('designer.profile.edit') }}" class="w-full flex items-center justify-center px-4 py-3 text-sm font-medium text-pink-600 bg-pink-50 hover:bg-pink-100 rounded-lg transition-all">
