...
<body class="bg-gradient-to-br from-gray-50 to-green-50">
            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0 flex items-center">
                        <div class="w-8 h-8 bg-gradient-to-r from-green-600 to-purple-600 rounded-lg flex items-center justify-center mr-3 shadow-md">
                            <i data-lucide="trending-up" class="w-5 h-5 text-white"></i>
                        </div>
                        <span class="text-xl font-bold bg-gradient-to-r from-green-600 to-purple-600 bg-clip-text text-transparent">Sanar Market - Marketing</span>
                    </div>
                </div>
    ...
    <div class="flex pt-16">
        <!-- Left Sidebar -->
        <div class="fixed left-0 top-16 w-64 h-screen bg-gradient-to-b from-white to-green-50 shadow-xl border-r border-gray-200 z-40 overflow-y-auto">
            <div class="p-6">
                <nav class="space-y-2">
                    <a href="{{ route('marketing.dashboard') }}" class="flex items-center px-4 py-3 text-sm font-medium text-white bg-gradient-to-r from-green-600 to-purple-600 rounded-lg shadow-md">
                    ...
                    <div class="pt-6">
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('marketing.advertisements') }}" class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gradient-to-r hover:from-green-50 hover:to-purple-50 hover:text-green-600 rounded-lg transition-all duration-200 group {{ request()->routeIs('marketing.advertisements') ? 'bg-gradient-to-r from-green-50 to-purple-50 text-green-600' : '' }}">
                            ...
                            <a href="{{ route('marketing.statistics') }}" class="flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gradient-to-r hover:from-purple-50 hover:to-green-50 hover:text-purple-600 rounded-lg transition-all duration-200 group {{ request()->routeIs('marketing.statistics') ? 'bg-gradient-to-r from-purple-50 to-green-50 text-purple-600' : '' }}">
                    ...
                    <div class="pt-6">
                        ...
                        <div class="px-4 mb-2">
                            <a href="{{ route('marketing.profile.edit') }}" class="w-full flex items-center justify-center px-4 py-3 text-sm font-medium text-green-600 bg-green-50 hover:bg-green-100 rounded-lg transition-all">
