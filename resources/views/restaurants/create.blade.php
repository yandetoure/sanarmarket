...
<section class="user-dashboard-hero">
    <div class="user-dashboard-container">
        ...
        <p>Remplissez les informations ci-dessous pour créer votre restaurant.</p>
    </div>
</section>
                ...
                <form method="POST" action="{{ route('restaurants.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description"
                                  ...
                                  placeholder="Décrivez votre restaurant, votre cuisine, vos spécialités...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="form-error">{{ $message }}</p>
                        @enderror
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;">
                        ...
                        <div class="form-group">
                            ...
                            <select id="price_range"
                                ...
                                <option value="€€" {{ old('price_range') == '€€' ? 'selected' : '' }}>€€ - Modéré</option>
                                <option value="€€€" {{ old('price_range') == '€€€' ? 'selected' : '' }}>€€€ - Élevé</option>
                                <option value="€€€€" {{ old('price_range') == '€€€€' ? 'selected' : '' }}>€€€€ - Très élevé</option>
                            </select>
                            @error('price_range')
                                <p class="form-error">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        @error('cover_image')
                            <p class="form-error">{{ $message }}</p>
                        @enderror
                        <p class="form-help">Image principale de votre restaurant (JPEG, PNG, JPG, GIF - Max 2MB)</p>
                    </div>
