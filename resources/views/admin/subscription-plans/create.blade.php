...
@section('content')
    <div class="px-8 py-5">
        <div class="flex items-center mb-8">
            ...
            <h1 class="text-3xl font-black text-slate-900">Nouveau Plan d'abonnement</h1>
        </div>

        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden">
                <form action="{{ route('admin.subscription-plans.store') }}" method="POST" class="p-8 space-y-6">
                    @csrf
                    ...
                    <div class="form-control">
                        ...
                        <textarea name="description" rows="3"
                            ...
                            placeholder="Avantages du plan...">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="form-control">
                            ...
                            <input type="number" name="price" value="{{ old('price', 0) }}" min="0" step="1"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="form-control">
                            ...
                            <input type="number" name="max_announcements" value="{{ old('max_announcements', 3) }}" min="1"
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="max_photos_per_announcement"
                                value="{{ old('max_photos_per_announcement', 3) }}" min="1"
                                class="input input-bordered w-full rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500">
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-8">
                        <label class="cursor-pointer label space-x-3">
                            <input type="checkbox" name="is_featured" value="1" {{ old('is_featured') ? 'checked' : '' }}
                                class="checkbox checkbox-warning rounded-lg">
