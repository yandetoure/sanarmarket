...
<div class="mb-8">
    ...
    <p class="text-gray-600 mt-2">Personnalisez l'apparence de votre espace administrateur</p>
</div>
...
<form method="POST" action="{{ route('admin.save-customization') }}" enctype="multipart/form-data" class="space-y-6">
@csrf
...
<div class="flex items-center justify-end gap-4">
    <a href="{{ route('admin.dashboard') }}" class="px-6 py-3 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 transition-colors">
        Annuler
    </a>
