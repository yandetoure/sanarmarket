...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center space-x-4 mb-8">
            ...
            <h1 class="text-2xl font-display font-bold text-slate-900">Modifier l'Annonce</h1>
        </div>
            ...
            <form action="{{ route('admin.announcements.update', $announcement) }}" method="POST" class="space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" name="price" value="{{ old('price', $announcement->price) }}"
                    ...
                    <div class="form-control">
                        ...
                        <select name="sub_category_id"
                            ...
                            @foreach($subcategories as $subcategory)
                                <option value="{{ $subcategory->id }}" {{ old('sub_category_id', $announcement->sub_category_id) == $subcategory->id ? 'selected' : '' }}>
                                    {{ $subcategory->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="location" value="{{ old('location', $announcement->location) }}"
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" name="phone" value="{{ old('phone', $announcement->phone) }}"
